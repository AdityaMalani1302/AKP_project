...
const { validateBody, itAssetSchema } = require('../../utils/validators');
...
router.get('/system-users', async (req, res) => {
    try {
        ...
        console.error('Error fetching system user details:', err);
...
router.post('/system-users', async (req, res) => {
    ...
    try {
        ...
        console.error('Error adding system user detail:', err);
...
router.put('/system-users/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('Error updating system user detail:', err);
...
router.delete('/system-users/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('Error deleting system user detail:', err);
...
router.put('/device-repaired/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('Error updating repair record:', err);
