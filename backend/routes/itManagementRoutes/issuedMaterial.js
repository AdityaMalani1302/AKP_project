...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('Error fetching issued material:', err);
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        console.error('Error adding issued material:', err);
...
router.put('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('Error updating issued material:', err);
...
router.delete('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error('Error deleting issued material:', err);
