...
const SleeveRequirement = () => {
    ...
    const [, setSelectedRows] = useState(new Set());
                ...
                <>
                    ...
                    <div className="section-container section-gray" style={{ marginBottom: '1.5rem' }}>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                        ...
                                        {sleeveData.map((row, index) => (
                                            ...
                                            >
                                                ...
                                                <td style={{ ...tdStyle, fontWeight: '500' }}>
                                                    {row.SleeveTypeName || row.SleeveType}
                                                </td>
                                                <td style={tdStyle}>
                                                    {row.SleeveQty}
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr style={{ backgroundColor: '#FEF3C7' }}>
                                            <td colSpan={4} style={{ ...tdStyle, textAlign: 'right', fontWeight: '600', borderTop: '2px solid #F59E0B' }}>
                                                Grand Total:
                                            </td>
                                            <td style={{ 
                                                ...tdStyle, 
                                            ...
                                            <td style={{ ...tdStyle, borderTop: '2px solid #F59E0B' }}></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                        ...
                        <AlertDialog
                            ...
                            message={`Are you sure you want to submit ${sleeveData.filter(row => !row.isSubmitted).length} pending sleeve requirement(s)?`}
                            ...
                            onConfirm={() => {
                                ...
                                submitMutation.mutate({
                                    ...
                                    onSettled: () => setShowSubmitDialog(false)
                                });
                            }}
                ...
                {(() => {
                    ...
                    const filteredRecords = records.filter(record => {
                        ...
                        if (filterSearch) {
                            ...
                            const matchesSleeveName = record.SleeveTypeName?.toLowerCase().includes(searchLower);
                            if (!matchesPattern && !matchesSleeve && !matchesSleeveName) return false;
                        }
                            ...
                            <tbody>
                                {filteredRecords.map((record, index) => (
                                    ...
                                    >
                                        ...
                                        <td style={{ ...recordTdStyle, fontWeight: '500' }}>{record.SleeveTypeName || record.SleeveType}</td>
                                        ...
                                        {printData.map((item, index) => (
                                            <tr key={index} style={{ 
                                                ...
                                                <td style={{ 
                                                    ...
                                                    {item.SleeveTypeName || item.SleeveType}
                                                </td>
                                                <td style={{ 
                                                    padding: '0.75rem 2rem',
                                                    borderBottom: '1px solid #e2e8f0',
