...
const PatternHistoryTab = () => {
    ...
    const getPrintStyles = () => `
        ...
        * { box-sizing: border-box; }
        ...
        h2 { margin: 0 0 1px 0; font-size: 7px; color: #1F2937; }
        table { width: 100%; border-collapse: collapse; font-size: 3.5px; table-layout: fixed; }
        td { padding: 0px 1px; border: 0.3px solid #E5E7EB; line-height: 0.9; height: 6px;
            overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
        tr:nth-child(odd) td { background-color: #F9FAFB !important; }
        tr:nth-child(even) td { background-color: white !important; }
        td:nth-child(1), td:nth-child(3) { font-weight: 500; color: #374151; width: 12%; }
        td:nth-child(2), td:nth-child(4) { width: 38%; }
        .card-header { background-color: #3B82F6 !important; color: white !important; padding: 0px 2px;
            font-weight: 600; font-size: 5px; margin-bottom: 0; height: 8px; line-height: 8px;
            -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
        .record-card { border: 0.3px solid #E5E7EB; border-radius: 1px; overflow: visible;
            margin-bottom: 1px; page-break-inside: auto; break-inside: auto; }
        @media print {
            body { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; background-color: white; }
            .card-header { background-color: #3B82F6 !important; color: white !important; }
            tr:nth-child(odd) td { background-color: #F9FAFB !important; }
    ...
    const handlePrint = () => {
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>Pattern No: ${escapeHtml(selectedPatternNo)}</title>
                <style>${getPrintStyles()}</style>
            </head>
            <body>
                <h2>Pattern No: ${escapeHtml(selectedPatternNo)}</h2>
                ${printContent}
            </body>
            </html>
        `);
    ...
    const handlePreview = () => {
        ...
        previewWindow.document.write(`
            ...
            <html>
            <head>
                <title>Preview - Pattern No: ${escapeHtml(selectedPatternNo)}</title>
                <style>
                ...
                <div className="section-container section-gray">
                    ...
                    {isQueryLoading ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '2rem', color: '#9CA3AF', fontStyle: 'italic' }}>
                            No records found for "{selectedPatternNo}". Verify the pattern number is correct.
                        </div>
                    ) : (
                        <>
                        <div 
                                        ...
                                        <table style={{ 
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style={cellStyle(false, true)}>{formatDate(record.Tooling_PO_Date)}</td>
                                                </tr>
                                                {/* Row 4 */}
                                                <tr>
                                                    ...
                                                    <td style={cellStyle(false, false)}>{formatDate(record.Purchase_Date)}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style={cellStyle(false, true)}>{formatDate(record.Core_Box_S7_F4_Date)}</td>
                                                </tr>
                                                {/* Row 10 */}
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style={cellStyle(false, false)}>{formatDate(record.Pattern_Received_Date)}</td>
                                                </tr>
                                                {/* Row 25 - Additional */}
                                                <tr>
                                                    ...
                                                    <td style={cellStyle(false, true)}>{formatDate(record.date)}</td>
                                                </tr>
