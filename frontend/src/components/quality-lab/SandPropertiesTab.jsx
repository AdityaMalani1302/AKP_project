...
const SandPropertiesTab = () => {
    ...
    const { data: records = [], isLoading, isError } = useQuery({
        queryKey: ['sandProperties', debouncedSearchTerm],
        queryFn: async () => {
            const url = debouncedSearchTerm ? `/quality-lab/sand?search=${encodeURIComponent(debouncedSearchTerm)}` : '/quality-lab/sand';
