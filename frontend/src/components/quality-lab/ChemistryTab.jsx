...
const ChemistryTab = () => {
    ...
    const { data: records = [], isLoading, isError } = useQuery({
        queryKey: ['chemistry', debouncedSearchTerm],
        queryFn: async () => {
            const url = debouncedSearchTerm ? `/quality-lab/chemistry?search=${encodeURIComponent(debouncedSearchTerm)}` : '/quality-lab/chemistry';
