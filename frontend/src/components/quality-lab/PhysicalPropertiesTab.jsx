...
const PhysicalPropertiesTab = () => {
    ...
    const { data: records = [], isLoading, isError } = useQuery({
        queryKey: ['physicalProperties', debouncedSearchTerm],
        queryFn: async () => {
            const url = debouncedSearchTerm 
                ? `/quality-lab/physical-properties?search=${encodeURIComponent(debouncedSearchTerm)}` 
                : '/quality-lab/physical-properties';
