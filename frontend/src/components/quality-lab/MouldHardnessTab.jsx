...
const MouldHardnessTab = () => {
    ...
    const { data: records = [], isLoading, isError } = useQuery({
        queryKey: ['mouldHardness', debouncedSearchTerm],
        queryFn: async () => {
            const url = debouncedSearchTerm ? `/quality-lab/mould-hardness?search=${encodeURIComponent(debouncedSearchTerm)}` : '/quality-lab/mould-hardness';
