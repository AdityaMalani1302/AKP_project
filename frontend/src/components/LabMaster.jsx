                    ...
                    {isQueryLoading ? (
                        ...
                        <table style={{ 
                            ...
                            <thead style={{ 
                                ...
                                <tr>
                                    {['Sr. No', 'Customer', 'Drg No', 'Description', 'Grade', 'Part Weight', 'Min/Max Thickness', 'Thickness Group', 'Base C', 'Base Si', 'C', 'Si', 'Mn', 'P', 'S', 'Cr', 'Cu', 'Mg', 'CE', 'Nickel', 'Moly', 'CRCA', 'RR', 'PIG', 'MS', 'Mg Mix', 'Regular/Critical', 'Last Box Temp', 'Remarks'].map((header) => (
                                        <th key={header} style={{
