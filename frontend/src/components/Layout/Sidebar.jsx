...
const NAV_ITEMS = [
    ...
    { path: '/fy-comparison', pageId: 'fy-comparison', label: 'Comparison Dashboard', icon: FiColumns },
    ...
    { path: '/ar-ap-dashboard', pageId: 'ar-ap-dashboard', label: 'Outstanding and Recovery Dashboard', icon: FiFileText },
