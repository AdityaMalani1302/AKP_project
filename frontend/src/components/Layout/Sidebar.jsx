...
const NAV_ITEMS = [
    { path: '/', pageId: 'dashboard', label: 'Dashboard', icon: FiHome },
...
const Sidebar = ({ user, onLogout, isOpen, onClose }) => {
    ...
    const getVisibleNavItems = () => {
        ...
        return NAV_ITEMS.filter(item => allowedPages.includes(item.pageId));
    };
        ...
        <>
            ...
            <aside
                style={{
                    ...
                    overflowX: 'hidden', // Hide overflow when collapsing
                    overflowY: 'auto'
                }}
                role="navigation"
