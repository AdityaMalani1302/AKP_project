...
const NewReadingPage = () => {
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true);
        try {
            await api.post('/quality-lab/sand-properties', formData);
            toast.success('Reading saved successfully');
            navigate('/quality-management-system/sand-testing');
        } catch (err) {
            const msg = err.response?.data?.error || 'Failed to save reading';
            toast.error(msg);
        } finally {
            setIsSaving(false);
        }
        ...
        <div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    >
                        {isSaving ? <FiLoader size={18} style={{ animation: 'spin 1s linear infinite' }} /> : <FiPlus size={18} />}
